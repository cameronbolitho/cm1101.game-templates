...
def normalise_input(user_input):
    ...
    # Iterate through chars, split into words
    # Could use str().split() but no 
    words, word = [], ""
    ...
    # Filter the extracted words
    basic_words = filter_words(words, skip_words)

    # Done, return basic word list
    return basic_words

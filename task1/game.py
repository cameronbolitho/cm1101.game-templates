...
def remove_punct(text):
    ...
    # Iterate through characters, copying to clean_text if non-punctuation.    
    clean_text = ""
...
def normalise_input(user_input):
    ...
    clean_input = remove_punct(clean_input)
    clean_input = remove_spaces(clean_input)
...
def display_room(room):
    ...
    uppercase_name = room["name"].upper()
...
def exit_leads_to(exits, direction):
    ...
    target_room = move(exits, direction)

    return target_room["name"]
...
def print_menu_line(direction, leads_to):
    ...
    print(f"Go {uppercase_direction} to {leads_to}.")
...
def print_menu(exits):
    ...
    # Print the menu line for each exit.
